...
void Function::Invoke(Thread* thread, Handle<Context> context, Handle<Function> function, size_t args_count, const Handle<Value>* args) {
...
void BytecodeFunction::DoInvoke(Thread* thread, size_t args_count, const Handle<Value>* args) {
