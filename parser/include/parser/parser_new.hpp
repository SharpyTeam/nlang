...
public:
    ...
    Holder<IExpression> ParseMultiplicativeExpression() { return ParseBinaryExpression<&ParserNew::ParsePrefixExpression, false, Associativity::LEFT, Token::MUL, Token::DIV, Token::REMAINDER>(); }
    Holder<IExpression> ParseAdditiveExpression() { return ParseBinaryExpression<&ParserNew::ParseMultiplicativeExpression, false, Associativity::LEFT, Token::ADD, Token::SUB>(); }
    Holder<IExpression> ParseInfixCallExpression() { return ParseBinaryExpression<&ParserNew::ParseAdditiveExpression, false, Associativity::LEFT, Token::IDENTIFIER>(); }
    Holder<IExpression> ParseComparisonExpression() { return ParseBinaryExpression<&ParserNew::ParseInfixCallExpression, false, Associativity::LEFT, Token::LESS_EQUALS, Token::GREATER_EQUALS, Token::LESS, Token::GREATER>(); }
    Holder<IExpression> ParseEqualityExpression() { return ParseBinaryExpression<&ParserNew::ParseComparisonExpression, false, Associativity::LEFT, Token::EQUALS, Token::NOT_EQUALS>(); }
    Holder<IExpression> ParseConjunctionExpression() { return ParseBinaryExpression<&ParserNew::ParseEqualityExpression, true, Associativity::LEFT, Token::AND>(); }
    Holder<IExpression> ParseDisjunctionExpression() { return ParseBinaryExpression<&ParserNew::ParseConjunctionExpression, true, Associativity::LEFT, Token::OR>(); }
    Holder<IExpression> ParseAssignmentExpression() { return ParseBinaryExpression<&ParserNew::ParseDisjunctionExpression, false, Associativity::RIGHT, Token::ASSIGN, Token::ASSIGN_ADD, Token::ASSIGN_SUB, Token::ASSIGN_MUL, Token::ASSIGN_DIV, Token::ASSIGN_REMAINDER>(); }
    ...
    using ParseExpressionFunctionPointer = Holder<IExpression> (ParserNew::*)();
    ...
    static Holder<ParserNew> New(Holder<Scanner>&& scanner) {
        return Holder<ParserNew>(new ParserNew(std::move(scanner)));
    }

private:
    explicit ParserNew(Holder<Scanner>&& scanner)
